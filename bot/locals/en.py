...
LOCAL = Local({
    ...
    'WELCOME_MESSAGE' : "Hi!\nI'm <b>@mxLeechRoBot</b>!\nPowered by @MovizenX.\nCreator: <a href='https://telegram.dog/AnnihilusOP>telegram.dog/AnnihilusOP</a>",
    ...
    'THUMBNAIL_DOWNLOADING' : 'thumbnail Download ho raha h😢.',
    'THUMBNAIL_DOWNLOADED' : 'Thumbnail download ho geya moj kar😁.',
    'THUMBNAIL_APPLIED' : 'Thumbnail applied kardi😎.',
    'THUMBNAIL_DELETING' : 'Deleting thumbnail🤧.',
    'THUMBNAIL_RESET' : 'Thumbnail reset kar diya😘.',
